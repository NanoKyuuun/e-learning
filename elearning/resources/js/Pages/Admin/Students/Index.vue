...
<template>
    ...
    <AdminLayout>
        <div class="mb-8">
            ...
            <p class="text-base-content/60">Kelola identitas akademik dan status aktif siswa secara global.</p>
        </div>
                    ...
                    <tbody>
                        <tr v-for="(student, index) in students.data" :key="student.id" class="hover">
                            ...
                            <td class="text-center">
                                <Link :href="route('admin.students.edit', student.id)" class="btn btn-sm btn-square btn-ghost hover:text-info">
