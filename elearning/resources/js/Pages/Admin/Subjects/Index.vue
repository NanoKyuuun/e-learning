...
watch(search, debounce((value) => {
    router.get(route('admin.subjects.index'), { search: value }, {
        preserveState: true,
        replace: true,
    });
}, 300));
    ...
    <AdminLayout>
        <div class="mb-8 flex flex-col md:flex-row md:items-center justify-between gap-4">
            <div>
                ...
                <p class="text-base-content/60">Kelola daftar mata pelajaran yang diajarkan secara global.</p>
            </div>
            <Link :href="route('admin.subjects.create')" class="btn btn-primary shadow-lg shadow-primary/20">
                        ...
                        <tr v-for="(subject, index) in subjects.data" :key="subject.id" class="hover">
                            ...
                            <td class="text-center">
                                <div class="flex justify-center gap-1">
                                    <Link :href="route('admin.subjects.edit', subject.id)" class="btn btn-sm btn-square btn-ghost hover:text-info">
