...
<template>
    ...
    <AdminLayout>
        <div class="mb-8">
            ...
            <p class="text-base-content/60">Kelola identitas akademik dan penempatan guru secara global.</p>
        </div>
                    ...
                    <tbody class="text-base-content/80">
                        <tr v-for="(teacher, index) in teachers.data" :key="teacher.id" class="hover">
                            ...
                            <td>
                                <div class="flex items-center gap-3">
                                    <div class="avatar" :class="teacher.user.avatar ? '' : 'placeholder'">
                                        <div v-if="teacher.user.avatar" class="w-8 h-8 rounded-full shadow-inner overflow-hidden border border-base-200">
                            ...
                            <td class="text-center">
                                <Link :href="route('admin.teachers.edit', teacher.id)" class="btn btn-sm btn-square btn-ghost hover:bg-info/10 hover:text-info">
