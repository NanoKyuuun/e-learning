...
const submit = () => {
    form.post(route('admin.teaching-assignments.store'));
};
</script>
            ...
            <div class="card-body">
                <div class="alert bg-info/5 border-none mb-6">
                    <div class="text-xs opacity-70">
                        Pilih kombinasi Guru, Mata Pelajaran, dan Kelas untuk periode semester aktif secara global.
                    </div>
                </div>
                ...
                <form @submit.prevent="submit" class="space-y-6">
                    ...
                    <div class="flex justify-end gap-4 mt-8 pt-6 border-t border-base-200">
                        <Link :href="route('admin.teaching-assignments.index')" class="btn btn-ghost">Batal</Link>
